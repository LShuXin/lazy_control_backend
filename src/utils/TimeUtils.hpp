...
#ifndef LAZY_CONTROL_BACKEND_TIMEUTILS_HPP
#define LAZY_CONTROL_BACKEND_TIMEUTILS_HPP
...
public:
    ...
    static std::string to_str_ex(const std::chrono::system_clock::time_point &time)
    {
        ...
        localtime_r(&tt, &local_time);
        //strftime(_time, 22, "%Y-%m-%d %H:%M:%S", local_time);
        sprintf(_time, "%d-%02d-%02d %02d:%02d:%02d.%03llu", local_time.tm_year+1900,
...
#endif //LAZY_CONTROL_BACKEND_TIMEUTILS_HPP
